...
const Information = () => {
  return (
    <section id="info" className='w-screen flex xl:flex-row flex-col justify-center min-h-screen gap-5 max-container'>
      ...
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-5 ml-5'>
        <h1 className='mt-2 font-palanquin text-4xl max-sm:text-[36px] max-sm:leading-[41px] font-bold'>
            <span className='xl:bg-white xl:whitespace-nowrap relative pr-1'>Tech Stacks... </span>
            <span className='text-coral-red inline-block mt-3 mb-4'>explained</span>
        </h1>
        <p className='font-monserrat text-orange-600 text-xl leading-8 mt-2 sm:max-w-sm lg:max-w-lg'>What is a tech stack?</p>
        <p className='font-monserrat text-slate-gray text-lg leading-8 mt-2 mb-5 sm:max-w-sm lg:max-w-lg'>In the context of modern web applications, tech stacks are sets of technologies that are "stacked" together and work in synergy to provide a fast, interactive, and dynamic user experience. "Full stacks" consist of front-end and back-end components.</p>
        <p className='font-monserrat text-orange-600 text-xl leading-8 mt-2 sm:max-w-sm lg:max-w-lg'>Why are they important?</p>
